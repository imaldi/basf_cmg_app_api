...
class FormUnloadingDieselOilController extends Controller
{
    ...
    public function createOrUpdate(Request $request)
    {
        $this->validate($request, [
            ...
            'un7_persiapan_check_fullbody_harness_desc' => 'string|max:255',
        ...
        try {
            ...
            $formUnloadingDieselOil->update([
                ...
                'un7_persiapan_check_fullbody_harness_desc' => $request->input('un7_persiapan_check_fullbody_harness_desc'),
