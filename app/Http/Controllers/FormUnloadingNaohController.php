...
class FormUnloadingNaohController extends Controller
{
    ...
    public function createOrUpdate(Request $request){
        $this->validate($request, [
            ...
            'un4_persiapan_bukasegel_ambil_sampel_desc' => ['integer', Rule::in(['0','1','2']),],
            ...
            'un4_persiapan_bukasegel_ambil_sampel' => 'string|max:255',
        ...
        try{
            ...
            $formUnloadingNaoh->update([
                ...
                'un4_persiapan_bukasegel_ambil_sampel_desc' => (int) $request->input('un4_persiapan_bukasegel_ambil_sampel_desc'),
                ...
                'un4_persiapan_bukasegel_ambil_sampel' => $request->input('un4_persiapan_bukasegel_ambil_sampel'),
