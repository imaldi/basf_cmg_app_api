...
class FormLoadingTexN701SController extends Controller
{
    ...
    public function createOrUpdateFormLoadingTexN701S(Request $request){
        $this->validate($request, [
            ...
            'ul1_persiapan_check_fullbody_harness_desc' => ['integer', Rule::in(['0','1','2']),],
        ...
        try{
            ...
            $formLoadingTexN701S->update([
                ...
                'ul1_persiapan_check_fullbody_harness_desc' => (int) $request->input('ul1_persiapan_check_fullbody_harness_desc'),
