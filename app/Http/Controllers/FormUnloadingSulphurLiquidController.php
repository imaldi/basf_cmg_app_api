...
class FormUnloadingSulphurLiquidController extends Controller
{
    ...
    public function createOrUpdate(Request $request)
    {
        $this->validate($request, [
            ...
            'un6_unloading_check_fullbody_harness_desc' => 'string|max:255',
        ...
        try {
            ...
            $formUnloadingSulphurLiquid->update([
                ...
                'un6_unloading_check_fullbody_harness_desc' => $request->input('un6_unloading_check_fullbody_harness_desc'),
