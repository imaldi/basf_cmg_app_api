...
class FormUnloadingFa1eoController extends Controller
{
    ...
    public function createOrUpdate(Request $request)
    {
        $this->validate($request, [
            ...
            'un2_persiapan_petugas_baik_body_isotank_desc' => 'string|max:255',
        ...
        try {
            ...
            if ($formId != null || $formId != 0) {
                ...
                try {
                    $formUnloadingFa1eo = FormUnloadingFa1eo::findOrFail($formId);
            ...
            $formUnloadingFa1eo->update([
                ...
                'un2_persiapan_petugas_baik_body_isotank_desc' => $request->input('un2_persiapan_petugas_baik_body_isotank_desc'),
