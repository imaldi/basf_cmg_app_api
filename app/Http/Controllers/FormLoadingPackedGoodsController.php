...
class FormLoadingPackedGoodsController extends Controller
{
    ...
    public function createOrUpdateFormLoadingPackedGoods(Request $request){
        $this->validate($request, [
            ...
            'ul2_simbol_api' => ['integer', Rule::in(['0','1']),],
            'ul2_simbol_cair' => ['integer', Rule::in(['0','1']),],
            'ul2_simbol_tanda_seru' => ['integer', Rule::in(['0','1']),],
            'ul2_simbol_flammable_solid' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_memakai_ppe' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_forklift_sudah_lulus' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_drum_handler_sdh_lulus' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_operator_terima_dokumen' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_arahkan_truk_parkir' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_stuffing_texapon_ocn' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_truk_besar_non_container' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_safety_cone_didepan_truk' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_ganjal_roda' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_cctv_berfungsi' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_pasang_signed_disisi_kanan' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_truk_bersih' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_sopir_serahkan_kunci' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_sopir_tinggalkan_area_unloading' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_adjusment_lvl_dock_aktif' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_safety_cone_pasang_di_adjusment_lvl' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_lantai_truk_bersih' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_container_export_checklist_7' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_utk_export_pallet_ispm_15' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_periksa_pallet' => ['integer', Rule::in(['0','1']),],
            'ul2_persiapan_pastikan_kemasan_kosong_bersih' => ['integer', Rule::in(['0','1']),],
            'ul2_loading_produk_tersusun_baik' => ['integer', Rule::in(['0','1']),],
            'ul2_loading_dry_container_export' => ['integer', Rule::in(['0','1']),],
            'ul2_loading_produk_pakai_pengaman' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_kembalikan_adjusment_leveler' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_khusus_cont_ocn_export' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_dg_produk_label_terpasang' => ['integer', Rule::in(['0','1']),],
            'ul2_loading_pastikan_tdk_orang' => ['integer', Rule::in(['0','1']),],
            'ul2_loading_muat_produk_ke_truk' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_panggil_sopir_kembali' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_angkat_safety_cone' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_nota_ekspor_wajib_ditandatangan' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_nota_lokal_wajib_ditandatangan' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_wh_spv_memastikan_ttd' => ['integer', Rule::in(['0','1']),],
            'ul2_selesai_khusus_produk_kosong_ttd' => ['integer', Rule::in(['0','1']),],
            'ul2_operator_complete' => ['integer', Rule::in(['0','1']),],
            'ul2_checker_complete' => ['integer', Rule::in(['0','1']),],
            'ul2_cancel_load_unload' => ['integer', Rule::in(['0','1']),],
            ...
            if( $formId != null || $formId != 0){
                try{
                    ...
                    $formLoadingPackedGoods->update([
                        ...
                        'ul2_jml_kemasan' => $request->input('ul2_jml_kemasan'),
                        'ul2_simbol_api' => $request->input('ul2_simbol_api'),
                        'ul2_simbol_cair' => $request->input('ul2_simbol_cair'),
                        'ul2_simbol_tanda_seru' => $request->input('ul2_simbol_tanda_seru'),
                        'ul2_simbol_flammable_solid' => $request->input('ul2_simbol_flammable_solid'),
                        'ul2_persiapan_memakai_ppe' => $request->input('ul2_persiapan_memakai_ppe'),
                        'ul2_persiapan_forklift_sudah_lulus' => $request->input('ul2_persiapan_forklift_sudah_lulus'),
                        'ul2_persiapan_drum_handler_sdh_lulus' => $request->input('ul2_persiapan_drum_handler_sdh_lulus'),
                        'ul2_persiapan_operator_terima_dokumen' => $request->input('ul2_persiapan_operator_terima_dokumen'),
                        'ul2_persiapan_arahkan_truk_parkir' => $request->input('ul2_persiapan_arahkan_truk_parkir'),
                        'ul2_persiapan_stuffing_texapon_ocn' => $request->input('ul2_persiapan_stuffing_texapon_ocn'),
                        'ul2_persiapan_truk_besar_non_container' => $request->input('ul2_persiapan_truk_besar_non_container'),
                        'ul2_persiapan_safety_cone_didepan_truk' => $request->input('ul2_persiapan_safety_cone_didepan_truk'),
                        'ul2_persiapan_ganjal_roda' => $request->input('ul2_persiapan_ganjal_roda'),
                        'ul2_persiapan_cctv_berfungsi' => $request->input('ul2_persiapan_cctv_berfungsi'),
                        'ul2_persiapan_pasang_signed_disisi_kanan' => $request->input('ul2_persiapan_pasang_signed_disisi_kanan'),
                        'ul2_persiapan_truk_bersih' => $request->input('ul2_persiapan_truk_bersih'),
                        'ul2_persiapan_sopir_serahkan_kunci' => $request->input('ul2_persiapan_sopir_serahkan_kunci'),
                        'ul2_persiapan_sopir_tinggalkan_area_unloading' => $request->input('ul2_persiapan_sopir_tinggalkan_area_unloading'),
                        'ul2_persiapan_adjusment_lvl_dock_aktif' => $request->input('ul2_persiapan_adjusment_lvl_dock_aktif'),
                        'ul2_persiapan_safety_cone_pasang_di_adjusment_lvl' => $request->input('ul2_persiapan_safety_cone_pasang_di_adjusment_lvl'),
                        'ul2_persiapan_lantai_truk_bersih' => $request->input('ul2_persiapan_lantai_truk_bersih'),
                        'ul2_persiapan_container_export_checklist_7' => $request->input('ul2_persiapan_container_export_checklist_7'),
                        'ul2_persiapan_utk_export_pallet_ispm_15' => $request->input('ul2_persiapan_utk_export_pallet_ispm_15'),
                        'ul2_persiapan_periksa_pallet' => $request->input('ul2_persiapan_periksa_pallet'),
                        'ul2_persiapan_pastikan_kemasan_kosong_bersih' => $request->input('ul2_persiapan_pastikan_kemasan_kosong_bersih'),
                        'ul2_loading_produk_tersusun_baik' => $request->input('ul2_loading_produk_tersusun_baik'),
                        'ul2_loading_dry_container_export' => $request->input('ul2_loading_dry_container_export'),
                        'ul2_loading_produk_pakai_pengaman' => $request->input('ul2_loading_produk_pakai_pengaman'),
                        'ul2_selesai_kembalikan_adjusment_leveler' => $request->input('ul2_selesai_kembalikan_adjusment_leveler'),
                        'ul2_selesai_khusus_cont_ocn_export' => $request->input('ul2_selesai_khusus_cont_ocn_export'),
                        'ul2_selesai_dg_produk_label_terpasang' => $request->input('ul2_selesai_dg_produk_label_terpasang'),
                        'ul2_loading_pastikan_tdk_orang' => $request->input('ul2_loading_pastikan_tdk_orang'),
                        'ul2_loading_muat_produk_ke_truk' => $request->input('ul2_loading_muat_produk_ke_truk'),
                        'ul2_selesai_panggil_sopir_kembali' => $request->input('ul2_selesai_panggil_sopir_kembali'),
                        'ul2_selesai_angkat_safety_cone' => $request->input('ul2_selesai_angkat_safety_cone'),
                        'ul2_selesai_nota_ekspor_wajib_ditandatangan' => $request->input('ul2_selesai_nota_ekspor_wajib_ditandatangan'),
                        'ul2_selesai_nota_lokal_wajib_ditandatangan' => $request->input('ul2_selesai_nota_lokal_wajib_ditandatangan'),
                        'ul2_selesai_wh_spv_memastikan_ttd' => $request->input('ul2_selesai_wh_spv_memastikan_ttd'),
                        'ul2_selesai_khusus_produk_kosong_ttd' => $request->input('ul2_selesai_khusus_produk_kosong_ttd'),
                        'ul2_operator_complete' => $request->input('ul2_operator_complete'),
                        'ul2_checker_complete' => $request->input('ul2_checker_complete'),
                        'ul2_cancel_load_unload' => $request->input('ul2_cancel_load_unload'),
                        'ul2_status' => $request->input('ul2_status'),
                    ...
                    return response()->json([
                        'code' => 200,
                        'message' => 'Success Update FormLoadingPackedGoods Form',
                        'data' => [
                ...
                return response()->json([
                    'code' => 200,
                    'message' => 'Success Create FormLoadingPackedGoods',
                    'data' => [
                        $formLoadingPackedGoods
                    ], 200);
            }
