...
class FormWorkOrderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'wo_form_status_id' => $this->wo_form_status,
