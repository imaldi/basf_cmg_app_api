...
class FormWorkOrderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'wo_issuer_name' => User::find($this->wo_issuer_id)->emp_name ?? null,
            'wo_spv_issuer_id' => (int)$this->wo_spv_issuer_id,
            'wo_spv_issuer_name' => User::find($this->wo_spv_issuer_id)->emp_name ?? null,
            ...
            'wo_category_detail' => FormWorkOrder::category($this->wo_category) ?? null,
            ...
            'wo_pic_attachment' => $this->wo_pic_attachment,
            ...
            'wo_form_status' => FormWorkOrder::formStatusDetail($this->wo_form_status) ?? null,
